<div class="siteContent" id="siteContent">
  <div class="productDiv">
    <div class="textDiv" id="textDiv">
      ...
      <p>Allerdings ist Yamaha nicht entgangen, dass ein Klavier nicht nur klingen muss, sondern auch optisch ansprechend gestaltet sein sollte. Das Piano ist von einem klassischen Piano optisch kaum zu entscheiden - gl&auml;nzender Lack und edle H&ouml;lzer, das zeichnet das &auml;u&szlig;ere dieses Pianos aus.</p>
      <p><u><strong>Eigenschaften des Yamaha Clavinova CLP-470PE:</strong></u></p>
      <ul>
        <li>Unterstützung vieler nützlicher Technologien, wie zum Beispiel:
          <ul>
            <li>Aufzeichnung des Spielens.</li>
            <li>USB-Support.</li>
            <li>Die Möglichkeit, den Ton über Kopfhörer umzuleiten.</li>
            <li>Eingebautes Metronom für Tempounterstützung.</li>
            <li>Lautstärkeregelung.</li>
            <li>Und noch vieles mehr...</li>
          </ul>
        </li>
        <li>Tasten aus massivem Holz (NW Tastatur mit Decklagen aus synthetischem Elfenbein)</li>
